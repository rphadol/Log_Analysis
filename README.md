...
10. To load the data --unzip newsdata.zip file and cd into the vagrant directory and use the command psql -d news -f newsdata.sql
11. Run 'psql -d new -f create_views.sql'
11. open another terminal cd to log analysis directory 
12. vagnat up >> vagrant ssh>> cd /vagrant >> run news.py
